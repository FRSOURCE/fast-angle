...
<template>
  <article :class="$style.article">
    ...
    <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and FRS Jakub Freisler ("<strong>Company</strong>," “<strong>we</strong>," “<strong>us</strong>," or “<strong>our</strong>”), concerning your access to and use of the <a :href="`${host}${basePath}`" v-text="`${host}${basePath}`" /> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in Poland and have our registered office at ul. Królewska 92 / 8, Kraków, Małopolska 30-079. Our VAT number is PL 6783179514. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
    ...
    <p>We care about data privacy and security.&nbsp;Please review our Privacy Policy: <strong><a :href="`${host}${basePath}${locale}/privacy-policy`" v-text="`${host}${basePath}${locale}/privacy-policy`" /></strong>.&nbsp;By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States.</p>
    <h2 id="terms">
