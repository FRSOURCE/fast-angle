...
<template>
  <article :class="$style.article">
    ...
    <p>
      ...
      you, whether personally or on behalf of an entity (“you”) and FRS Jakub
      Freisler ("<strong>Company</strong>," “<strong>we</strong>,"
      “<strong>us</strong>," or “<strong>our</strong>”), concerning your access
      to and use of the
      <a :href="`${host}${basePath}`" v-text="`${host}${basePath}`" /> website
      ...
      the “Site”). We are registered in Poland and have our registered office at
      ul. Królewska 92 / 8, Kraków, Małopolska 30-079. Our VAT number is PL
      6783179514. You agree that by accessing the Site, you have read,
    ...
    <p>
      ...
      minor, you have received parental permission to use the Site; (3) you will
      not access the Site through automated or non-human means, whether through
      a bot, script, or otherwise; (4) you will not use the Site for any illegal
      or unauthorized purpose; and (5) your use of the Site will not violate any
    ...
    <p>
      ...
      access the Site: (1) the license granted to you for our mobile application
      ...
      support services with respect to the mobile application; (3) in the event
      ...
      application; (4) you represent and warrant that (i) you are not located in
      ...
      restricted parties; (5) you must comply with applicable third-party terms
    ...
    <p>
      ...
      <strong
        ><a
          :href="`${host}${basePath}${locale}/privacy-policy`"
          v-text="`${host}${basePath}${locale}/privacy-policy`" /></strong
    ...
    <p>
      ...
      MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE ANY CONTENT
    ...
    <p>
      ...
      Poland, and the use of the United Nations Convention of Contracts for the
      ...
      country of residence. FRS Jakub Freisler and yourself both agree to submit
      to the non-exclusive jurisdiction of the courts of Krowodrza, Kraków,
      Poland, which means that you may make a claim to defend your consumer
      protection rights in regards to these Terms of Use in Poland, or in the EU
    ...
    <p>
      ...
      acceptance. The seat of arbitration shall be Kraków, Poland.&nbsp;The
      language of the proceedings shall be English. Applicable rules of
      substantive law shall be the law of Poland.
    </p>
    ...
    <p>
      ...
      ARISING OR $0.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT
