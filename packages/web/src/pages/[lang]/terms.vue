...
<template>
  <article :class="$style.article">
    ...
    <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and FRS Jakub Freisler ("<strong>Company</strong>," “<strong>we</strong>," “<strong>us</strong>," or “<strong>our</strong>”), concerning your access to and use of the <a href="https://www.frsource.org/fast-angle/">https://www.frsource.org/fast-angle/</a> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in Poland and have our registered office at ul. Królewska 92 / 8, Kraków, Małopolska 30-079. Our VAT number is PL 6783179514. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
    ...
    <p>We care about data privacy and security.&nbsp;Please review our Privacy Policy: <strong><a href="https://www.frsource.org/fast-angle/en/privacy-policy">https://www.frsource.org/fast-angle/en/privacy-policy</a></strong>.&nbsp;By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States.</p>
    <h2 id="terms">
    ...
    <p>These conditions are governed by and interpreted following the laws of Poland, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. FRS Jakub Freisler and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Krowodrza, Kraków, Poland, which means that you may make a claim to defend your consumer protection rights in regards to these Terms of Use in Poland, or in the EU country in which you reside.</p>
    <h2 id="disputes">
