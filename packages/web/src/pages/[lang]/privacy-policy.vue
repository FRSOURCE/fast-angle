  ...
  <article :class="$style.article">
    <header>
      <hgroup>
        ...
        <h6><small>Last updated November 03, 2022</small></h6>
      </hgroup>
    </header>
    ...
    <ul>
      <li>Download and use our mobile application (Fast Angle), or any other application of ours that links to this privacy notice</li>
    </ul>
    <ul>
      <li>Engage with us in other related ways, including any sales, marketing, or events</li>
    </ul>
    <p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at hi@frsource.org.</p>
    ...
    <p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with FRS Jakub Freisler and the Services, the choices you make, and the products and features you use. Click&nbsp;<a href="#personalinfo">here</a>&nbsp;to learn more.</p>
    ...
    <p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by filling out our data subject request form available here: privacy@frsource.org, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
    <p>Want to learn more about what FRS Jakub Freisler does with any information we collect? Click&nbsp;<a href="#toc">here</a> to review the notice in full.</p>
    <h2 id="toc">
      TABLE OF CONTENTS
    </h2>
    <ol>
    ...
    <ul>
      <li>
        <strong>Consent.&nbsp;</strong>We may process your information if you have given us permission (i.e., consent) to use your personal information for a specific purpose. You can withdraw your consent at any time. Click&nbsp;<a href="#withdrawconsent">here</a>&nbsp;to learn more.
      </li>
    </ul>
    <ul>
    ...
    <p>&nbsp;</p>
    <p>If you are located in the EEA or UK and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <a class="break-all" href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm">https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm</a>.</p>
    <p>If you are located in Switzerland, the contact details for the data protection authorities are available here: <a class="break-all" href="https://www.edoeb.admin.ch/edoeb/en/home.html">https://www.edoeb.admin.ch/edoeb/en/home.html</a>.</p>
    <p><strong>Withdrawing your consent:</strong> If we are relying on your consent to process your personal information, which may be express and/or implied consent depending on the applicable law, you have the right to withdraw your consent at any time. You can withdraw your consent at any time by contacting us by using the contact details provided in the section "<a href="#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>" below.</p>
    <p>However, please note that this will not affect the lawfulness of the processing before its withdrawal nor, when applicable law allows, will it affect the processing of your personal information conducted in reliance on lawful processing grounds other than consent.</p>
    <p>If you have questions or comments about your privacy rights, you may email us at privacy@frsource.org.</p>
    <h2 id="DNT">
    ...
    <p>You may contact us by email at&nbsp;ccpa@frsource.org, or by referring to the contact details at the bottom of this document.</p>
    ...
    <p>FRS Jakub Freisler&nbsp;has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. FRS Jakub Freisler&nbsp;will not sell personal information in the future belonging to website visitors, users, and other consumers.</p>
    ...
    <p>To exercise these rights, you can contact us&nbsp;by email at ccpa@frsource.org, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
    <h2 id="policyupdates">
    ...
    <p>If you have questions or comments about this notice, you may email us at privacy@frsource.org or by post to:</p>
    <address>
      FRS Jakub Freisler<br>
      ul. Królewska 92 / 8<br>
      Kraków, Małopolska 30-079<br>
      Poland
    </address>
    <h2 id="request">
      11. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?
    </h2>
    <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please email us at: privacy@frsource.org.</p>
  </article>
</template>
