...
<template>
  <article :class="$style.article">
    ...
    <p>
      This privacy notice for FRS Jakub Freisler ("<strong>Company</strong>,"
    ...
    <ul>
      <li>
        ...
        <a :href="`${host}${basePath}`" v-text="`${host}${basePath}`" />, or any
        website of ours that links to this privacy notice
      </li>
    </ul>
    <ul>
      <li>
        Download and use our mobile application (Fast Angle), or any other
    ...
    <p>
      <strong
        ...
        the section you are looking for. You can also click&nbsp;</strong
    ...
    <p>
      ...
      depending on how you interact with FRS Jakub Freisler and the Services,
      the choices you make, and the products and features you use. Click&nbsp;<a
        href="#personalinfo"
        >here</a
      >&nbsp;to learn more.
    </p>
    ...
    <p>
      ...
      rights regarding your personal information. Click&nbsp;<a
        href="#privacyrights"
        >here</a
      >
      to learn more.
    ...
    <p>
      ...
      available here: privacy@frsource.org, or by contacting us. We will
      consider and act upon any request in accordance with applicable data
      protection laws.
    </p>
    <p>
      Want to learn more about what FRS Jakub Freisler does with any information
      we collect? Click&nbsp;<a href="#toc">here</a> to review the notice in
      full.
    </p>
    ...
    <p>
      <strong>In Short:</strong><strong>&nbsp;</strong>We collect personal
    ...
    <ul>
      <li>
        ...
        time. Click&nbsp;<a href="#withdrawconsent">here</a>&nbsp;to learn more.
      </li>
    </ul>
    <ul>
      <li>
    ...
    <p>
      <strong
        >If you are located in Canada, this section applies to you.</strong
      >
    </p>
    <p>
      ...
      implied consent). You can withdraw your consent at any time. Click&nbsp;<a
    ...
    <p>
      ...
      <a class="break-all" href="https://www.edoeb.admin.ch/edoeb/en/home.html"
    ...
    <p>
      You may contact us by email at&nbsp;ccpa@frsource.org, or by referring to
    ...
    <p>
      FRS Jakub Freisler&nbsp;has not disclosed or sold any personal information
      to third parties for a business or commercial purpose in the preceding
      twelve (12) months. FRS Jakub Freisler&nbsp;will not sell personal
    ...
    <p>
      ...
      ccpa@frsource.org, or by referring to the contact details at the bottom of
      this document. If you have a complaint about how we handle your data, we
    ...
    <p>
      ...
      privacy@frsource.org or by post to:
    </p>
    <address>
    ...
    <p>
      ...
      your personal information, please email us at: privacy@frsource.org.
    </p>
  </article>
</template>
